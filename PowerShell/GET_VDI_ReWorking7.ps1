...
#Import VMwareUAG module
Import-Module .\VMwareUAG.psm1
...
#UAG Status
$secPass = ConvertTo-SecureString -String $UAGpswd -AsPlainText -Force
$credential = New-Object System.Management.Automation.PSCredential($UAGuser, $secPass)

$UAGMonitor = Get-VMwareUAGHealth -hostname $UAGserverIP -credential $credential

if ($UAGMonitor.status -match "RUNNING")
{ $UAGAlive = 1 }

Write-Output (" ")
Write-Output (" ")
Write-Output ("=======================================")
Write-Output ("UAG Health Status                      ")
Write-Output ("=======================================")
Write-Output ("UAG Server: " + $UAGserverIP + " Status: " + $UAGAlive)
Write-Output ("=======================================")
Write-Output ("End of UAG Health Status               ")
Write-Output ("=======================================")
